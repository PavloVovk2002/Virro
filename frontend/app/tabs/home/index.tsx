...
const dummyTasks = [
  ...
  { id: '4', name: 'Client feedback', due: '2025-05-03' },
  { id: '5', name: 'Email marketing draft', due: '2025-05-05' },
  { id: '6', name: 'Revise onboarding flow', due: '2025-05-06' },
  { id: '7', name: 'Push production build', due: '2025-05-07' },
];

export default function HomeScreen() {
  const [tasks, setTasks] = useState(
    [...dummyTasks].sort((a, b) => new Date(a.due).getTime() - new Date(b.due).getTime())
  );
          ...
          <View style={styles.topCard}>
            ...
            <View style={styles.inProgressBar}>
              <Text style={styles.inProgressText}>
                In Progress • Remaining Tasks {remainingTasks}/{totalTasks}
              </Text>
            </View>
          </View>

          {/* Tasks label (outside card) */}
